...
$Data_Enum_toCharCode = ->(c) { c.ord }
$Data_Enum_fromCharCode = ->(c) { c.chr(Encoding::UTF_8) }
$Data_Bounded_bottomChar = 0.chr(Encoding::UTF_8)
$Data_Bounded_topChar = 65535.chr(Encoding::UTF_8)
$Data_Int_toStringAs = ->(radix) { ->(i) { i.to_s(radix) } }
